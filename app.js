...
function sumArray(sss) {
    var sumarrrr = 0;
    for (let w = 0; w < sss.length; w++) {
        sumarrrr = sumarrrr + sss[w]
    }

    return [sumarrrr, sss + " was passed in as an array of numbers, and " + sumarrrr + " is their sum."];
}
...
function multiplyArray(multArr) {
    ...
    return [multyy, "The numbers " + multArr + " have a product of " + multyy + "."];
}
