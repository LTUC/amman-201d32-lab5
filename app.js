...
let sum3 = sum(a, b)[0];
let total = sum(sum3, c)[0];
let result3 = multiply(a, b)[0];
let total2 = multiply(result3, c)[0];
...
function multiplyArray(multArr) { //eslint-disable-line
    let result5 = multiply(multArr[0], multArr[1])[0];
    let total5 = multiply(result5, multArr[2])[0];
    
    return [total5, 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have ' + 'a ' + 'product ' + 'of ' + total5 + '.']
