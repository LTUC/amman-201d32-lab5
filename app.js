...
function sum(a,b) { //eslint-disable-line
    ...
    let sumnum = a+b; 
    let arr1= [sumnum,"The sum of "+a+" and " +b+ " is " +sumnum+"."];
return arr1; 
}
//  problem 1 solved 
...
function multiply(a, b) { //eslint-disable-line
    let mult = a*b ; 
    let arr2 = [mult,"The product of "+a+" and "+b+" is "+mult+"."]
    return arr2 ;
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    let mul2 = multiply(multiply(a, b)[0], c)[0]; 
    
    let sdf = [sum1,mul2,a+" and "+b+" and "+c+" sum to "+sum1+ ".","The product of "+a+" and "+b+" and "+c+" is "+mul2+"."];
...
function sumArray(sumArr) { //eslint-disable-line
    let sum2 = sum(sum(2,3)[0], 4)[0];
   
    return [sum2,"2,3,4 was passed in as an array of numbers, and "+sum2+" is their sum."]
...
Write a function called multiplyArray()
 that takes an array of numbers as its argument and returns an array
  whose first element is the product of those numbers,
 and the second element is a string that EXACTLY follows this example and uses the values that were input into the function:
...
function multiplyArray(multArr) { //eslint-disable-line
    let mul3 = multiply(multiply(2, 3)[0], 4)[0]; 
return[mul3,"The numbers 2,3,4 have a product of "+mul3+"."];
