...
the first element is the sum of those three numbers, the second element is the product of those three numbers,  and the third and fourth elements are strings that EXACTLY follow this example and use the values that were input into the function:
...
and to do multiplication, use your multiply() function that you've already created.
...
the product of those numbers, and the second element is a string that EXACTLY follows this example
